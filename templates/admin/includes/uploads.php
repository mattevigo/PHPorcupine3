...
/* images */
define("IMAGE_DEFAULT_HEIGHT", 300);
define("IMAGE_DEFAULT_QUALITY", 0);
 ...
 * @return
 */
function upload_image_resize($file_path, $new_height=IMAGE_DEFAULT_HEIGHT, $dir=IMAGES_DIR)
{
...
function thumbnail($file_path)
{
	...
	$width = $info_image[0];
	$area = $width/$height;
	$new_height = THUMB_DEFAULT_HEIGHT;
